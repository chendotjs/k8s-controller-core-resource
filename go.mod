module github.com/chendotjs/k8s-controller-core-resource
...
require (
	...
	k8s.io/api v0.0.0-20180414221806-6fb8575d8ac3
	k8s.io/apimachinery v0.0.0-20180414221351-ba81bc69c72d
